...
<head>
    ...
    <link href="<?= SITE_TEMPLATE_PATH ?>/assets/font-awesome/css/font-awesome.min.css" rel="stylesheet"
          type="text/css">
    ...
    <link href='http://fonts.googleapis.com/css?family=Cardo:400,400italic,700' rel='stylesheet' type='text/css'>
    <link href="<?= SITE_TEMPLATE_PATH ?>/assets/css/plugins/owl-carousel/owl.carousel.css" rel="stylesheet"
          type="text/css">
    <link href="<?= SITE_TEMPLATE_PATH ?>/assets/css/plugins/owl-carousel/owl.theme.css" rel="stylesheet"
          type="text/css">
    <link href="<?= SITE_TEMPLATE_PATH ?>/assets/css/plugins/owl-carousel/owl.transitions.css" rel="stylesheet"
          type="text/css">
    ...
    <link id="changeable-colors" rel="stylesheet" href="<?= SITE_TEMPLATE_PATH ?>/assets/css\vitality-blue.css">
...
<header style="background-image: url('<?= SITE_TEMPLATE_PATH ?>/assets/img/creative/header08.jpg');">
    <div class="intro-content">
        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/creative/profile.png" class="img-responsive img-centered" alt="">
        <div class="brand-name hard-text-shadow">
            <? $APPLICATION->IncludeComponent(
                "bitrix:main.include",
                ".default",
                array(
